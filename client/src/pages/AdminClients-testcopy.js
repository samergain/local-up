...
function AdminClients() {
    ...
    async function displayClientDtl(event, client) {
        ...
        console.log("IOutside Map: ", client); 
        const ticketInfo = client.clientTickets.map( async ticket => {
            console.log("Inside Map: ", ticket);

            let ticketDetails =  await API.getTicket(ticket);
                            // .then(res => res.data)
                            // .catch(error => console.log("Error while reading ticketInfo: ", error));
            return ticketDetails;
        })

        console.log("Print ticket: ", ticketInfo);
        // console.log("Print ticketInfo -  Id: ", ticketInfo.data);
        // console.log("Print ticketInfo -  Title: ", ticketInfo[0].data.title);
        // console.log("Print ticketInfo -  Desc: ", ticketInfo[0].data.description);
                            ...
                            <LightSpeed left>
                                <div className="card">
                                    ...
                                    <p className="pad-card-info">
                                        ...
                                        <strong>Created:</strong> {ticketInfo.created_at} <br />
                                    ...
                                    <div className="card-body text-center">
                                        <ProjectButton
                                            ...
                                            ticketCreated={ticketInfo.created_at}
                            ...
                            <LightSpeed clear>
                                <div className="card">
                                    ...
                                    <p className="pad-card-info">
                                        ...
                                        <strong>Created Date:</strong>  {projectForm.ticketCreated}<br />
                                    </p>
                                    <div className="card-body">
                                        <ProjectForm
